            ...
            <ul>
                ...
                <li class="has-dropdown">
                    <a href="#" class="dropdown-toggle"><i class="fas fa-edit"></i> <span>Cadastros</span><i
                            class="fas fa-chevron-down caret"></i></a>
                    <ul class="dropdown">
                        <li><a href="categoria-cadastrar.php"><i class="fas fa-thin fa-tags"></i>
                                <span>Categoria</span></a></li>
                        <li><a href="cliente-cadastrar.php"><i class="fas fa-thin fa-user"></i> <span>Cliente</span></a>
                        </li>
                        <li><a href="funcionario-cadastrar.php"><i class="fas fa-thin fa-user-tie"></i>
                                <span>Funcionário</span></a></li>
                        <li><a href="marca-cadastrar.php"><i class="fas fa-thin fa-registered"></i>
                                <span>Marca</span></a></li>
                        <li><a href="produto-cadastrar.php"><i class="fas fa-box"></i> <span>Produto</span></a></li>
                    </ul>
                </li>

                <li class="has-dropdown">
                    <a href="#" class="dropdown-toggle"><i class="fas fa-list"></i> <span>Listagem</span><i
                            class="fas fa-chevron-down caret"></i></a>
                    <ul class="dropdown">
                        <li><a href="categoria-listar.php"><i class="fas fa-thin fa-tags"></i>
                                <span>Categoria</span></a></li>
                        <li><a href="cliente-listar.php"><i class="fas fa-thin fa-user"></i> <span>Cliente</span></a>
                        </li>
                        <li><a href="funcionario-listar.php"><i class="fas fa-thin fa-user-tie"></i>
                                <span>Funcionário</span></a></li>
